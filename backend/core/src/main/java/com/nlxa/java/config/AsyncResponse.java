...
public class AsyncResponse<V> implements Future<V> {
    ...
    private boolean isComletedExceptionally = false;
    ...
    public AsyncResponse(Throwable ex) {
        ...
        this.isComletedExceptionally = true;
        this.isDone = true;
    }
    ...
    public boolean isComletedExceptionally(){
        return this.isComletedExceptionally;
    }
